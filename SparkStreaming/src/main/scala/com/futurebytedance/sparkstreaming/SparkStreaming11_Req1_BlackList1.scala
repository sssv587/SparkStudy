...
/**
 * @author yuhang.sun 2021/4/8 - 22:46
 * @version 1.0
 *          SparkStreaming-实时黑名单计算-代码封装
 */
                  ...
                  if (flag) {
                    ...
                    val sql2 =
                      """
                        ...
                        |"""
                    val flag1: Boolean = JDBCUtil.isExist(conn, sql2, Array(day, user, ad))
